...
import { View, Text, TextInput, Button, FlatList, Alert, StyleSheet, TouchableOpacity, SafeAreaView, Platform, StatusBar } from 'react-native';
...
export default function HomeScreen() {
  ...
  const renderItem = ({ item }) => {
    ...
    return (
      <View style={[styles.item, isFlash ? styles.flash : null]}>
        <View>
...
const styles = StyleSheet.create({
  ...
  input: { borderWidth:1, borderColor:'#ddd', padding:10, borderRadius:8, marginBottom:10, color:'#111', backgroundColor:'#fff' },
  listWrap: { flex:1 },
  ...
  flash: { backgroundColor: '#fff1f1' },
  phone: { fontFamily: Platform.OS === 'ios' ? 'Menlo' : 'monospace', fontWeight:'600' },
